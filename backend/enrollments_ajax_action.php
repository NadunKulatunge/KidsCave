 ...
 {  
      ...
      if($_POST["action"] =="Add")  
      {
           ...
           $procedure = "  
                CREATE PROCEDURE insertUser(IN name varchar(100), email varchar(100), role varchar(9), gender varchar(6), birthday varchar(10), classroom int(11) )  
                BEGIN 
                    INSERT INTO tbl_users(userName, userEmail, userRole, classID, gender, birthday) VALUES (name, email, role, classroom, gender, birthday);
                END;  
           ";  
      ...
      {  
           ...
           $procedure = "  
                CREATE PROCEDURE updateUser(IN ID int(11), name varchar(100), email varchar(100), role varchar(9), gender varchar(6), birthday varchar(10), classroom int(11) )  
                BEGIN
                    UPDATE tbl_users SET userName = name, userEmail = email, userRole = role, classID = classroom, gender = gender, birthday = birthday WHERE userID = ID;        
                END;   
           ";
           ...
           {  
                if(mysqli_query($connect, $procedure))  
                {  
                     $query = "CALL updateUser('".$_POST["id"]."', '".$name."', '".$email."', '".$role."', '".$gender."', '".$birthday."', '".$classroom."')";
                     mysqli_query($connect, $query);  
                     echo 'Data Updated';  
                }  
           }  
